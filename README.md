...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/dpd-sdk.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/dpd-sdk)
...
```bash
php artisan vendor:publish --tag="dpd-sdk-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="dpd-sdk-views"
```

## Usage

```php
$dpd = new SmartDato\Dpd();
echo $dpd->echoPhrase('Hello, SmartDato!');
```
